...
public class DungeonLevelSO : ScriptableObject
{
    ...
    [Tooltip("Populate the list with the room templates that you want to be part of the level. You need to ensure that room templates are included for all" +
        "room node types that are specified in Room Node Graphs for the level.")]
    #endregion
    ...
    private void OnValidate()
    {
        ...
        // Check to make sure that room templates are specified for all the node types in the speficied node graphs.
