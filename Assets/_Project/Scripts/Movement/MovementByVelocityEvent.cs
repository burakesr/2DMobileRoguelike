...
public class MovementByVelocityEvent : MonoBehaviour
{
    ...
    public void CallMovementByVelocityEvent(Vector2 direction, float moveSpeed)
    {
        OnMovementByVelocity?.Invoke(this, new MovementByVelocityArgs() { moveDirection = direction, moveSpeed = moveSpeed });
    }
}
