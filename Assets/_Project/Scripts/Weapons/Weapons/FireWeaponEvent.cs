...
public class FireWeaponEvent : MonoBehaviour
{
    ...
    public void CallFireWeaponEvent(bool fire, bool firePreviousFrame, AimDirection aimDirection, float aimAngle, float weaponAimAngle, Vector3 weaponAimDirectionVector) => OnFireWeapon?.Invoke(this, new FireWeaponEventArgs()
    {
        fire = fire,
