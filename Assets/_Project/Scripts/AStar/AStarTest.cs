...
public class AStarTest : MonoBehaviour
{
    ...
    private Vector3Int nullValue = new Vector3Int(9999, 9999, 9999);
    ...
    private void OnRoomChanged(RoomChangedEventArgs roomChangedEventArgs)
    {
        ...
        startGridPosition = nullValue;
        endGridPosition = nullValue;
    ...
    private void SetUpPathTilemap()
    {
        ...
        // If the front tilemap hasn't been cloned the clone it
    ...
    {
        if (startGridPosition == nullValue)
        {
    ...
    private void ClearPath()
    {
        ...
        // Clear Start and Finish positions
        endGridPosition = nullValue;
        startGridPosition = nullValue;
    }
    ...
    {
        if (startGridPosition == nullValue || endGridPosition == nullValue) return;
